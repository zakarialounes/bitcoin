...
require_once(_PS_MODULE_DIR_ . 'bitcoin/vendors/Blockchain/Exceptions.php');
require_once(_PS_MODULE_DIR_ . 'bitcoin/vendors/Blockchain/Rates.php');
require_once(_PS_MODULE_DIR_ . 'bitcoin/vendors/Blockchain/Receive.php');

/**
 * Blockchain PHP API
 * @link https://github.com/blockchain/api-v1-client-php/
 */
class Blockchain {
    ...
    public function __construct($api_code = null) {
        ...
        //curl_setopt($this->ch, CURLOPT_CAINFO, _PS_MODULE_DIR_ . 'bitcoin/vendors/Blockchain/ca-bundle.crt');
